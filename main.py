...
def hometab(): # this function contains code for home page
    ...
    def top_hits_tab(): # defining the function that will execute when user clicks on top hits button on homepage
        ...
        background_image = PhotoImage(file="photos//3bck.png")
        ...
        def on_enter1_(e): # function for giving hovering effects to the buttons while entering the button
            button1_['background'] = "#e9f5f9"
            button1_['foreground'] = "#134b5f"

        def on_leave1_(e): # function for giving hovering effects to the buttons while leaving the button
            button1_['background'] = "#134b5f"
            button1_['foreground'] = "#e9f5f9"

        button1_ = Button(text="return", font="aerial 12 bold", borderwidth=0, highlightthickness=0,
                          relief="flat", fg="#e9f5f9", bg="#134b5f", activeforeground="#134b5f",
                          activebackground="#e9f5f9", command=back)
    ...
    def top_genres(): # defining the function that will execute when user clicks on top_genres button on homepage
        ...
        button1_ = Button(text="return", font="aerial 12 bold", borderwidth=0, highlightthickness=0,
                          relief="flat", fg="#e9f5f9", bg="#134b5f", activeforeground="#134b5f",
                          activebackground="#e9f5f9", command=backgo)
        button1_.bind("<Enter>", on_enter1_) # hovering effect while entering
        button1_.bind("<Leave>", on_leave1_) # hovering effect while leaving
        button1_.place(x=3, y=3.4, width=141, height=48)
    ...
    def rate_to_get(): # defining the function that will execute when user clicks on "rate to get" button on homepage
        ...
        def rate_to_get_result(): # function to display the top9 movies after rating done by user
            ...
            background2_image = PhotoImage(file="photos//3bck.png")
    ...
    photo_logo = PhotoImage(file="photos//233.png")
    root.iconphoto(False, photo_logo)
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
    background_img_home = PhotoImage(file="photos/yoho.png")

    background_img_label = Label(root, image=background_img_home, bg="#ffffff", bd=0, width=screen_width, height=screen_height,
                             highlightthickness=0, relief="ridge")
    background_img_label.image = background_img_home
    background_img_label.pack(fill="both", expand=True)


    def on_enter1(e): # function for giving hovering effects to the button while entering the button1
        mybutton1['background'] = "#e9f5f9"
        mybutton1['foreground'] = "#134b5f"

    def on_leave1(e): # function for giving hovering effects to the button while leaving the button1
        mybutton1['background'] = "#134b5f"
        mybutton1['foreground'] = "#e9f5f9"

    mybutton1 = Button(text="Popular", font="aerial 12 bold", borderwidth=0, highlightthickness=0, relief="raised",
                       fg="#e9f5f9", bg="#134b5f", activeforeground="#134b5f", activebackground="#e9f5f9",
    ...
    def on_enter2(e): # function for giving hovering effects to the button while entering the button2
        mybutton2['background'] = '#e9f5f9'
        mybutton2['foreground'] = "#134b5f"

    def on_leave2(e): # function for giving hovering effects to the button while leaving the button2
        mybutton2['background'] = "#134b5f"
        mybutton2['foreground'] = '#e9f5f9'

    mybutton2 = Button(text="Genre Hits", font="aerial 12 bold", borderwidth=0, highlightthickness=0, relief="flat",
                       fg='#e9f5f9', bg="#134b5f", activeforeground="#134b5f", activebackground="#e9f5f9", command=top_genres
                       )
    ...
    def on_enter3(e): # function for giving hovering effects to the button while entering the button3
        mybutton3['background'] = '#e9f5f9'
        mybutton3['foreground'] = "#134b5f"

    def on_leave3(e): # function for giving hovering effects to the button while leaving the button3
        mybutton3['background'] = "#134b5f"
        mybutton3['foreground'] = '#e9f5f9'

    mybutton3 = Button(text="Similar Movies", font="aerial 12 bold", borderwidth=0, highlightthickness=0,
                       relief="flat", fg='#e9f5f9', bg="#134b5f", activeforeground="#134b5f",command=similar_to_search,
                       activebackground='#e9f5f9')
    ...
    def on_enter4(e): # function for giving hovering effects to the button while entering the button4
        mybutton4['background'] = '#e9f5f9'
        mybutton4['foreground'] = "#134b5f"

    def on_leave4(e): # function for giving hovering effects to the button while leaving the button4
        mybutton4['background'] = "#134b5f"
        mybutton4['foreground'] = '#e9f5f9'

    mybutton4 = Button(text="Rate Movies", font="aerial 12 bold", borderwidth=0, highlightthickness=0,
                       relief="flat", fg='#e9f5f9', bg="#134b5f", activeforeground="#134b5f",
                       activebackground='#e9f5f9',command=rate_to_get)
